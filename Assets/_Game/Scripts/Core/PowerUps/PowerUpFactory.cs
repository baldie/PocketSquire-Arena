...
namespace PocketSquire.Arena.Core.PowerUps
{
    ...
    public static class PowerUpFactory
    {
        ...
        private static readonly List<ComponentTemplate> _templates = new()
        {
            ...
            new() { UniqueKey = "ATTR_MAGIC", BaseWeight = 10f, 
                Factory = (r, rk) => new AttributeModifierComponent(AttributeModifierComponent.AttributeType.Magic, 2f, r, rk) },
            new() { UniqueKey = "ATTR_DEXTERITY", BaseWeight = 10f, 
                Factory = (r, rk) => new AttributeModifierComponent(AttributeModifierComponent.AttributeType.Dexterity, 2f, r, rk) },
            ...
            new() { UniqueKey = "DEBUFF_LUCK", BaseWeight = 7f, 
                Factory = (r, rk) => new MonsterDebuffComponent(MonsterDebuffComponent.DebuffType.Luck, 1f, r, rk) },
            new() { UniqueKey = "DEBUFF_DEXTERITY", BaseWeight = 7f, 
                Factory = (r, rk) => new MonsterDebuffComponent(MonsterDebuffComponent.DebuffType.Dexterity, 1f, r, rk) },
            new() { UniqueKey = "DEBUFF_MAGIC", BaseWeight = 7f, 
                Factory = (r, rk) => new MonsterDebuffComponent(MonsterDebuffComponent.DebuffType.Magic, 1f, r, rk) },
            new() { UniqueKey = "DEBUFF_CONSTITUTION", BaseWeight = 7f, 
                Factory = (r, rk) => new MonsterDebuffComponent(MonsterDebuffComponent.DebuffType.Constitution, 1f, r, rk) },
        };
